...
namespace WsSiopel
{
    ...
    public partial class wsSiopel : System.Web.UI.Page
    {
        WsSIOPEL. IwsSistemaInternoSiopelClient wsClient = new WsSIOPEL.IwsSistemaInternoSiopelClient();
        WsSIOPEL.TWSResponse Respuesta = new WsSIOPEL.TWSResponse();
        ...
        protected void btnTrading_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (txtsessionWS.Value.Trim() != "")
                {
                    ...
                    WsSIOPEL.TDatosAltaTrading DatosAlta = new WsSIOPEL.TDatosAltaTrading();
                    WsSIOPEL.TDatosEstadoTrading DatosEstado = new WsSIOPEL.TDatosEstadoTrading();
                    ...
                    WsSIOPEL.TDatosTNE DatosTNE = new WsSIOPEL.TDatosTNE(); 
