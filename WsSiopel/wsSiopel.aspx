<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wsSiopel.aspx.cs" Inherits="WsSiopel.wsSiopel" %>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="txtEspecie" id="txtEspecie" placeholder="TEXTO" class="input-block-level" runat="server" value="R00108 014000$1"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label for="lbl" class="control-label col-sm-2">Plazo Vuelta</label>
                                                    <div class="controls">
                                                        <input type="text" name="txtPlazoVuelta" id="txtPlazoVuelta" placeholder="VALOR ENTERO" class="input-block-level" runat="server"  value="0"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label for="lbl" class="control-label col-sm-2" style="color:red">Destinatario</label>
                                                    <div class="controls">
                                                        <input type="text" name="txtDestinatario" id="txtDestinatario" placeholder="TEXTO" class="input-block-level" runat="server" value="D34612"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label for="lbl" class="control-label col-sm-2" style="color:red">Cantidad</label>
                                                    <div class="controls">
                                                        <input type="text" name="txtCantidad" id="txtCantidad" placeholder="Decimal" class="input-block-level" runat="server" value="10000000" />
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label for="lbl" class="control-label col-sm-2" style="color:red">Precio</label>
                                                    <div class="controls">
                                                        <input type="text" name="txtPrecio" id="txtPrecio" placeholder="Decimal" class="input-block-level" runat="server"  value="101.2" />
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="control-group">
                                                    <label for="lblsession" class="control-label col-sm-2" style="color:red">TipoTrading</label>
                                                    <div class="controls">
                                               ...
                                               <%-- <div class="control-group">
                                                ...
                                                <div class="control-group">
                                                    <label for="lblsession" class="control-label col-sm-2">Cantidad Garantia </label>
                                                    <div class="controls">
                                                        <input type="text" name="txtCantidadGarantia" id="txtCantidadGarantia" placeholder="Decimal" class="input-block-level" runat="server" value="0" />
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label for="lblsession" class="control-label col-sm-2">Precio Garantia</label>
                                                    <div class="controls">
                                                        <input type="text" name="txtPrecioGarantia" id="txtPrecioGarantia" placeholder="Decimal" class="input-block-level" runat="server" value="0"/>
                                                    </div>
                                                </div>
                                                <div class="control-group">
